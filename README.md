...
```python
Bedrock(
   model_id="amazon.titan-text-lite-v1", #adjust to use different model
    ...
    Policies:
      ...
      - Statement:
          - Sid: "BedrockScopedAccess"
            ...
            Resource:
              - "arn:aws:bedrock:*::foundation-model/amazon.titan-text-lite-v1" # adjust with different model
